...
const styles = {
  ...
  trendGraphInteractiveVectorCanvasArea: { height: '160px', display: 'flex', justifyContent: 'space-around', alignItems: 'flex-end', backgroundColor: '#050811', borderRadius: '14px', border: '1px solid #111726', padding: '20px 10px', boxSizing: 'border-box', width: '100%' },
  trendGraphColumnTrackAligner: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: '45px', gap: '8px' },
  trendGraphPillarMassBodyStrip: { width: '12px', position: 'relative', borderRadius: '3px 3px 0 0', boxShadow: '0 4px 10px rgba(0,0,0,0.3)', transition: 'height 0.4s ease' },
  trendGraphPillarGlowTopCapHead: { position: 'absolute', top: 0, left: 0, right: 0, height: '3px', backgroundColor: '#60a5fa' },
  individualTankProgressRowItem: { display: 'flex', flexDirection: 'column', width: '100%' },
  aiInsightDataFlexWrapper: { display: 'flex', gap: '20px', alignItems: 'center', width: '100%', textAlign: 'left' },
  aiBrainTopologyMicroGridMeshGraphic: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px', opacity: 0.2 },
  aiMeshPulsePointNodeIndicator: { width: '16px', height: '16px', border: '2px solid #2563eb', borderRadius: '50%', animation: 'pulseMatrixRadarGlowPoint 2s infinite ease-in-out' },
  aiInsightParagraphNarrativeText: { margin: 0, fontSize: '0.85rem', color: '#64748b', lineHeight: '1.6', flex: 1 },
  donutAnalyticsCanvasGraphicContainer: { width: '100%', display: 'flex', justifyContent: 'center', padding: '10px 0' },
  donutChartOuterCircleConicGradientTrack: { width: '120px', height: '120px', borderRadius: '50%', background: 'conic-gradient(#2563eb 0% 55%, #fbbf24 55% 80%, #10b981 80% 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 20px rgba(0,0,0,0.4)' },
  donutChartInternalDataLabelHoleCore: { width: '92px', height: '92px', borderRadius: '50%', backgroundColor: '#090d16', display: 'flex', flexDirection: 'column', alignItems: 'center', '../../': 'center', justifyContent: 'center' },
  hardwareMotorPanelCentralAlignerBlock: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '18px', width: '100%' },
  hardwareMotorPumpChamberIsometricCaseShell: { width: '100px', height: '70px', backgroundColor: '#1e293b', borderRadius: '12px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'inset -6px -6px 12px rgba(0,0,0,0.5), 0 8px 16px rgba(0,0,0,0.4)' },
  hardwareMotorSpindleRotorFinPropellerBlade: { width: '30px', height: '30px', borderRadius: '4px', boxShadow: '0 0 6px rgba(0,0,0,0.5)' },
  hardwareMotorDischargeNozzleApertureOutletPipe: { position: 'absolute', right: '-10px', width: '1000071323', width: '10px', height: '36px', backgroundColor: '#0f172a' },
  hardwareManualOverrideSwitchButtonTrigger: { border: 'none', color: '#fff', padding: '12px 20px', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '0.85rem', width: '100%', transition: 'background-color 0.2s', boxShadow: '0 4px 10px rgba(0,0,0,0.2)' },
  genericViewTabWrapperGrid: { display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' },
  qualityContainerGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', width: '100%' },
  qualityBlock: { padding: '24px', backgroundColor: '#040711', borderRadius: '14px', border: '1px solid #111726', fontSize: '0.9rem', color: '#64748b', display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', justifyContent: 'center' },
  sliderInteractiveValveModule: { width: '100%', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '10px' },
